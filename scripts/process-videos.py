...
TIP_CATALOG: dict[str, tuple[str, str, str]] = {
    ...
    "site-visit-importance": (
        "Зачем нужна экскурсия по действующим объектам.mp4",
        "Общее",
        "Зачем ехать на действующие объекты перед ремонтом и что это даёт.",
    ),
    "avoid-random-interior": (
        "Как не получить случайный результат в интерьере.MOV",
        "Дизайн",
        "Как избежать случайного результата в интерьере и управлять итогом.",
    ),
    "bedroom-design-choice": (
        "Какой дизайн выбрать для спальни.MP4",
        "Дизайн",
        "Как выбрать дизайн спальни: стиль, цвет и функциональные решения.",
    ),
    "design-project-necessity": (
        "Почему дизайн проект - это не роскошь а необходимость.MP4",
        "Общее",
        "Почему дизайн-проект — необходимость, а не роскошь при ремонте.",
    ),
    "narrow-specialists": (
        "Почему нужно выбирать узкопрофильных специалистов.MP4",
        "Общее",
        "Зачем выбирать узкопрофильных специалистов вместо «мастера на все руки».",
    ),
}
